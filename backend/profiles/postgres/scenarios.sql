...
"varchar_10" varchar(10) COLLATE "default" NOT NULL,
"id_detail" int4,
"enum" varchar(255) COLLATE "default",
"default" varchar(255) COLLATE "default" NOT NULL
)
WITH (OIDS=FALSE)
...
-- ----------------------------
INSERT INTO "demo"."scenario1" VALUES ('1', 'Andon', '88', '1.32', '1', '1', '2017-05-05', '2017-05-04 00:00:00', 'asdfasdfasdfadfl;djasfa', 'Nam@quisdiamluctus.org', '1234567890', '1', 'ok', 'FOOBAR');
INSERT INTO "demo"."scenario1" VALUES ('2', 'Atkins', '44', '5.55', '1.5', '1', '2012-03-16', '2017-05-05 12:30:00', null, 'arcu.et.pede@musProin.cam', 'Ishmael', '2', 'not_ok', 'foobar');
INSERT INTO "demo"."scenario1" VALUES ('3', 'Hamilton', '10', '10.50', '1', '1', '2012-03-16', null, null, 'dui@duiCras.edu', 'Mohammad', '3', 'ok', 'FOOBAR');
INSERT INTO "demo"."scenario1" VALUES ('4', 'Nicholas', '18', '1.92', '2', '0', '2012-03-16', null, null, 'mollis@eutellus.co.uk', 'Troy', '4', null, 'FOOBAR');
INSERT INTO "demo"."scenario1" VALUES ('5', 'Schwartz', '79', '1.50', '1', '0', '2012-03-16', null, null, 'ante@adipiscing.org', 'Carla', '1', null, 'there');
